...
func test_action_log_roundtrips_through_dict() -> void:
	...
	assert_eq(restored.engine_version, "0.1.0-test")
...
func test_replay_reproduces_final_state() -> void:
	...
	var r1: Replay.ReplayResult = Replay.replay(log, "0.1.0-test")
	var r2: Replay.ReplayResult = Replay.replay(log, "0.1.0-test")
